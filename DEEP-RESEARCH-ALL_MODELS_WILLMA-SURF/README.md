# TRUTH FINDING with SURF AI-Hub (WILLMA SURF) in Langflow 1.10.1
...
Geïnteresseerde onderzoekers kunnen mailen naar R.F.van.der.willigen@hr.nl met verzoek om te kunnen beschikken over de json flow file.
...
![Summaries Subvraag](FIGs/TOP_TIER_PROMPT_ANSWER_002.png)
...
![Eindrapport Deel 1 - Definitie](FIGs/TOP_TIER_PROMPT_FINAL_ANSWER_005.png)
![Eindrapport Deel 2 - Model Overzicht Tabel](FIGs/TOP_TIER_PROMPT_FINAL_ANSWER_006.png)
![Eindrapport Deel 3 - Open Source vs Proprietary](FIGs/TOP_TIER_PROMPT_FINAL_ANSWER_007.png)
